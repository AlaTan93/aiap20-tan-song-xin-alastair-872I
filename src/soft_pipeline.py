...
def process_soft_data(filename="", train=True):
    """
    Gets soft data pipeline
    TODO
    ...
    if (train):
        ...
        df_encoded.loc[df_encoded["Subscription Status"] == 'yes', 'Subscription Status'] = 0.9
        df_encoded.loc[df_encoded["Subscription Status"] == 'no', 'Subscription Status'] = 0.1
        df_encoded["Subscription Status"] = df_encoded["Subscription Status"].astype(float)
        ...
        y_val.loc[y_val == 0.9] = 1.0
        y_val.loc[y_val == 0.1] = 0.0
